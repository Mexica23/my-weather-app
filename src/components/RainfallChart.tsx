...
import { RainfallHistoryPoint } from '../type';
import { RainfallIcon } from '../constants';

interface RainfallChartProps {
  data: RainfallHistoryPoint[];
}
  ...
  return (
    <div className="bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-sky-500/30 transition-shadow duration-300">
      <div className="flex items-center mb-4">
        <RainfallIcon className="w-6 h-6 text-sky-400 mr-2" />
        <h3 className="text-xl font-semibold text-slate-100">Rainfall Intensity Over Time</h3>
      </div>
